package flex.utils.ui.resize {
	...
	public class ResizeManager {
		 ...
		 */
		private function drawResizeArea(g:Graphics, color:uint, alpha:Number, xx:Number, yy:Number, w:Number, h:Number):void {
			// no border
			g.lineStyle(0, 0, 0);
		 ...
		 */
		private function drawResizeDot(g:Graphics, color:uint, alpha:Number, xx:Number, yy:Number, w:Number=2, h:Number=2):void {
			// no border
			g.lineStyle(0, 0, 0);
			// fill the dot
			g.beginFill(color, alpha);
