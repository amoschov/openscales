package org.openscales.core.i18n {
	...
	public class PropertiesLoaderTest extends TestCase {
		...
		public function testPropertiesLoaderX1():void {
			...
			this._rpl1.addEventListener(IOErrorEvent.IO_ERROR, addAsync(checkOkAsyncPropertiesLoaderX1, 500, {}, checkNOkAsyncPropertiesLoaderX1));
		...
		public function testPropertiesLoaderX2():void {
			...
			this._rpl2.addEventListener(Event.COMPLETE, addAsync(checkOkAsyncPropertiesLoaderX2, 500, {}, checkNOkAsyncPropertiesLoaderX2));
		...
		public function testPropertiesLoaderX3():void {
			...
			this._rpl3.addEventListener(Event.COMPLETE, addAsync(checkOkAsyncPropertiesLoaderX3, 500, {lang: "en"}, checkNOkAsyncPropertiesLoaderX3));
		...
		private function checkOkAsyncPropertiesLoaderX3(e:Event, data:Object):void {
			...
			if (data.lang == "en") {
				this._rpl3.addEventListener(Event.COMPLETE, addAsync(checkOkAsyncPropertiesLoaderX3, 500, {lang: "fr"}, checkNOkAsyncPropertiesLoaderX3));
