package org.openscales.core.i18n {
	...
	public class LocalizedPropertiesTest extends TestCase {
		...
		public function testLocalizedPropertiesX1():void {
			...
			this._lp1.addEventListener(LanguageEvent.LOADED_LANG, addAsync(onLanguageLoaded, 500, this._data1));
			this._lp1.addEventListener(LanguageEvent.FAILED_LOADING_LANG, addAsync(onLanguageFailedLoaded, 500, this._data1));
