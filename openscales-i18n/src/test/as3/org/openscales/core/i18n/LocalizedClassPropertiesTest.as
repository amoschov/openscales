package org.openscales.core.i18n {
	...
	public class LocalizedClassPropertiesTest extends TestCase {
		...
		public function testLocalizedClassPropertiesX1():void {
			...
			this._lcp1.addEventListener(LanguageEvent.LOADED_LANG, addAsync(onLanguageLoaded, 500, this._data1));
			this._lcp1.addEventListener(LanguageEvent.FAILED_LOADING_LANG, addAsync(onLanguageFailedLoaded, 500, this._data1));
		...
		public function testLocalizedClassPropertiesX2():void {
			...
			this._lcp2.addEventListener(LanguageEvent.CHANGE_LANG, addAsync(onLanguageChanged, 500));
			this._lcp2.setLocale(Lang.EN, {"first.property": "one", "a text": "whitespace property"});
			...
			this._lcp2.setLocale(Lang.FR, {"first.property": "un", "a text": "une propriété avec des espaces"});
