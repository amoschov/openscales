...
package org.opengis.referencing.cs
{
    ...
    public final class AxisDirection extends CodeList {
         ...
         */
        public static const COLUMN_POSITIVE:AxisDirection=
            new AxisDirection("COLUMN_POSITIVE", "columnPositive");

        /**
         * Axis positive direction is towards lower pixel column.
         */
        public static const COLUMN_NEGATIVE:AxisDirection=
            new AxisDirection("COLUMN_NEGATIVE", "columnNegative", COLUMN_POSITIVE);

        /**
         * Axis positive direction is towards top of approximately vertical display surface.
         */
        public static const DISPLAY_UP:AxisDirection=
            new AxisDirection("DISPLAY_UP", "displayUp");

        /**
         * Axis positive direction is towards bottom of approximately vertical display surface.
         */
        public static const DISPLAY_DOWN:AxisDirection=
            new AxisDirection("DISPLAY_DOWN", "displayDown", DISPLAY_UP);

        /**
         * Axis positive direction is right in display.
         */
        public static const DISPLAY_RIGHT:AxisDirection=
            new AxisDirection("DISPLAY_RIGHT", "displayRight");

        /**
         * Axis positive direction is left in display.
         */
        public static const DISPLAY_LEFT:AxisDirection=
            new AxisDirection("DISPLAY_LEFT", "displayLeft", DISPLAY_RIGHT);

        /**
         * Axis positive direction is up relative to gravity.
         */
        public static const UP:AxisDirection=
            new AxisDirection("UP", "up");

        /**
         * Axis positive direction is down relative to gravity.
         */
        public static const DOWN:AxisDirection=
            new AxisDirection("DOWN", "down", UP);

        /**
         * Axis positive direction is π/2 radians clockwise from north.
         */
        public static const EAST:AxisDirection=
            new AxisDirection("EAST", "east");

        /**
         * Axis positive direction is approximately east-north-east.
         */
        public static const EAST_NORTH_EAST:AxisDirection=
            new AxisDirection("EAST_NORTH_EAST", "eastNorthEast");

        /**
         * Axis positive direction is approximately east-south-east.
         */
        public static const EAST_SOUTH_EAST:AxisDirection=
            new AxisDirection("EAST_SOUTH_EAST", "eastSouthEast");

        /**
         * Axis positive direction is towards the future.
         */
        public static const FUTURE:AxisDirection=
            new AxisDirection("FUTURE", "future");

        /**
         * Axis positive direction is towards the past.
         */
        public static const PAST:AxisDirection=
            new AxisDirection("PAST", "past", FUTURE);
         ...
         */
        public static const GEOCENTRIC_X:AxisDirection=
            new AxisDirection("GEOCENTRIC_X", "geocentricX");
         ...
         * prime meridian.
         */
        public static const GEOCENTRIC_Y:AxisDirection=
            new AxisDirection("GEOCENTRIC_Y", "geocentricY");

        /**
         * Axis positive direction is from the centre of the modelled earth parallel to its rotation
         * axis and towards its north pole.
         */
        public static const GEOCENTRIC_Z:AxisDirection=
            new AxisDirection("GEOCENTRIC_Z", "geocentricZ");

        /**
         * Axis positive direction is north.
         */
        public static const NORTH:AxisDirection=
            new AxisDirection("NORTH", "north");

        /**
         * Axis positive direction is approximately north-east.
         */
        public static const NORTH_EAST:AxisDirection=
            new AxisDirection("NORTH_EAST", "northEast");

        /**
         * Axis positive direction is approximately north-north-east.
         */
        public static const NORTH_NORTH_EAST:AxisDirection=
            new AxisDirection("NORTH_NORTH_EAST", "northNorthEast");

        /**
         * Axis positive direction is approximately north-north-west.
         */
        public static const NORTH_NORTH_WEST:AxisDirection=
            new AxisDirection("NORTH_NORTH_WEST", "northNortWest");

        /**
         * Axis positive direction is approximately north-west.
         */
        public static const NORTH_WEST:AxisDirection=
            new AxisDirection("NORTH_WEST", "northWest");

        /**
         * Unknown or unspecified axis orientation.
         */
        public static const OTHER:AxisDirection=
            new AxisDirection("OTHER", "other");

        /**
         * Axis positive direction is towards higher pixel row.
         */
        public static const ROW_POSITIVE:AxisDirection=
            new AxisDirection("ROW_POSITIVE", "rowPositive");

        /**
         * Axis positive direction is towards lower pixel row.
         */
        public static const ROW_NEGATIVE:AxisDirection=
            new AxisDirection("ROW_NEGATIVE", "rowNegative", ROW_POSITIVE);

        /**
         * Axis positive direction is π radians clockwise from north.
         */
        public static const SOUTH:AxisDirection=
            new AxisDirection("SOUTH", "south", NORTH);

        /**
         * Axis positive direction is approximately south-east.
         */
        public static const SOUTH_EAST:AxisDirection=
            new AxisDirection("SOUTH_EAST", "southEast", NORTH_WEST);

        /**
         * Axis positive direction is approximately south-south-east.
         */
        public static const SOUTH_SOUTH_EAST:AxisDirection=
            new AxisDirection("SOUTH_SOUTH_EAST", "southSouthEast", NORTH_NORTH_WEST);

        /**
         * Axis positive direction is approximately south-south-west.
         */
        public static const SOUTH_SOUTH_WEST:AxisDirection=
            new AxisDirection("SOUTH_SOUTH_WEST", "southSouthWest", NORTH_NORTH_EAST);

        /**
         * Axis positive direction is approximately south-west.
         */
        public static const SOUTH_WEST:AxisDirection=
            new AxisDirection("SOUTH_WEST", "southWest", NORTH_EAST);

        /**
         * Axis positive direction is 3π/2 radians clockwise from north.
         */
        public static const WEST:AxisDirection=
            new AxisDirection("WEST", "west", EAST);

        /**
         * Axis positive direction is approximately west-north-west.
         */
        public static const WEST_NORTH_WEST:AxisDirection=
            new AxisDirection("WEST_NORTH_WEST", "westNorthWest", EAST_SOUTH_EAST);

        /**
         * Axis positive direction is approximately west-south-west.
         */
        public static const WEST_SOUTH_WEST:AxisDirection=
            new AxisDirection("WEST_SOUTH_WEST", "westsouthWest", EAST_NORTH_EAST);
        ...
        public function opposite ( ) : AxisDirection {
            return this._oppositeOrdinal==-1?
                        null
                   :
                        AxisDirection.VALUES[this._oppositeOrdinal];
        }
