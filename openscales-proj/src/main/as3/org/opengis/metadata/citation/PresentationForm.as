...
package org.opengis.metadata.citation
{
    ...
    public final class PresentationForm extends CodeList {
         ...
         */
        public static const DOCUMENT_DIGITAL:PresentationForm=
            new PresentationForm("DOCUMENT_DIGITAL", "documentDigital");

        /**
         * Representation of a primarily textual item (can contain illustrations also) on paper,
         * photographic material, or other media.
         */
        public static const DOCUMENT_HARDCOPY:PresentationForm=
            new PresentationForm("DOCUMENT_HARDCOPY", "documentHardcopy");
         ...
         */
        public static const IMAGE_DIGITAL:PresentationForm=
            new PresentationForm("IMAGE_DIGITAL", "imageDigital");
         ...
         */
        public static const IMAGE_HARDCOPY:PresentationForm=
            new PresentationForm("IMAGE_HARDCOPY", "imageHardcopy");

        /**
         * Map represented in raster or vector form.
         */
        public static const MAP_DIGITAL:PresentationForm=
            new PresentationForm("MAP_DIGITAL", "mapDigital");

        /**
         * Map printed on paper, photographic material, or other media for use directly by the human
         * user.
         */
        public static const MAP_HARDCOPY:PresentationForm=
            new PresentationForm("MAP_HARDCOPY", "mapHardcopy");

        /**
         * Multi-dimensional digital representation of a feature, process, etc.
         */
        public static const MODEL_DIGITAL:PresentationForm=
            new PresentationForm("MODEL_DIGITAL", "modelDigital");

        /**
         * 3-dimensional, physical model.
         */
        public static const MODEL_HARDCOPY:PresentationForm=
            new PresentationForm("MODEL_HARDCOPY", "modelHardcopy");

        /**
         * Vertical cross-section in digital form.
         */
        public static const PROFILE_DIGITAL:PresentationForm=
            new PresentationForm("PROFILE_DIGITAL", "profileDigital");

        /**
         * Vertical cross-section printed on paper, etc.
         */
        public static const PROFILE_HARDCOPY:PresentationForm=
            new PresentationForm("PROFILE_HARDCOPY", "profileHardcopy");

        /**
         * Digital representation of facts or figures systematically displayed, especially in columns.
         */
        public static const TABLE_DIGITAL:PresentationForm=
            new PresentationForm("TABLE_DIGITAL", "tableDigital");
         ...
         */
        public static const TABLE_HARDCOPY:PresentationForm=
            new PresentationForm("TABLE_HARDCOPY", "tableHardcopy");

        /**
         * Digital video recording.
         */
        public static const VIDEO_DIGITAL:PresentationForm=
            new PresentationForm("VIDEO_DIGITAL", "videoDigital");

        /**
         * Video recording on film.
         */
        public static const VIDEO_HARDCOPY:PresentationForm=
            new PresentationForm("VIDEO_HARDCOPY", "videoHardcopy");
