...
package org.opengis.metadata.citation
{
    ...
    public final class Role extends CodeList {
         ...
         */
        public static const AUTHOR:Role=
            new Role("AUTHOR", "author");
         ...
         */
        public static const CUSTODIAN:Role=
            new Role("CUSTODIAN", "custodian");

        /**
         * Party who distributes the resource.
         */
        public static const DISTRIBUTOR:Role=
            new Role("DISTRIBUTOR", "distributor");

        /**
         * Party who created the resource.
         */
        public static const ORIGINATOR:Role=
            new Role("ORIGINATOR", "originator");

        /**
         * Party that owns the resource.
         */
        public static const OWNER:Role=
            new Role("OWNER", "owner");

        /**
         * Party who can be contacted for acquiring knowledge about or acquisition of the resource.
         */
        public static const POINT_OF_CONTACT:Role=
            new Role("POINT_OF_CONTACT", "pointOfContact");

        /**
         * Key party responsible for gathering information and conducting research.
         */
        public static const PRINCIPAL_INVESTIGATOR:Role=
            new Role("PRINCIPAL_INVESTIGATOR", "principalInvestigator");

        /**
         * Party who has processed the data in a manner such that the resource has been modified.
         */
        public static const PROCESSOR:Role=
            new Role("PROCESSOR", "processor");

        /**
         * Party who published the resource.
         */
        public static const PUBLISHER:Role=
            new Role("PUBLISHER", "publisher");

        /**
         * Party that supplies the resource.
         */
        public static const RESOURCE_PROVIDER:Role=
            new Role("RESOURCE_PROVIDER", "resourceProvider");

        /**
         * Party who uses the resource.
         */
        public static const USER:Role=
            new Role("USER", "user");
