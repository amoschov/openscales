...
package org.opengis.metadata.citation {
	...
	public final class DateType extends CodeList {
		 ...
		 */
		public static const CREATION:DateType=new DateType("CREATION", "creation");

		/**
		 * Date identifying when the resource was issued.
		 */
		public static const PUBLICATION:DateType=new DateType("PUBLICATION", "publication");

		/**
		 * Date identifying when the resource was examined or re-examined and improved or amended.
		 */
		public static const REVISION:DateType=new DateType("REVISION", "revision");
