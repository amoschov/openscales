...
package org.opengis.metadata.citation {
	...
	public final class OnLineFunction extends CodeList {
		 ...
		 */
		public static const DOWNLOAD:OnLineFunction=new OnLineFunction("DOWNLOAD", "download");

		/**
		 * Online information about the resource.
		 */
		public static const INFORMATION:OnLineFunction=new OnLineFunction("INFORMATION", "information");

		/**
		 * Online instructions for requesting the resource from the provider.
		 */
		public static const OFFLINE_ACCESS:OnLineFunction=new OnLineFunction("OFFLINE_ACCESS", "offlineAccess");

		/**
		 * Online order process for obtaining the resource.
		 */
		public static const ORDER:OnLineFunction=new OnLineFunction("ORDER", "order");

		/**
		 * Online search interface for seeking out information about the resource.
		 */
		public static const SEARCH:OnLineFunction=new OnLineFunction("SEARCH", "search");
